...
export function constructMetadata({
  title = "DocuPitch | The Open Source DocSend Alternative",
  description = "DocuPitch is an open-source document sharing alternative to DocSend with built-in engagement analytics and 100% white-labeling.",

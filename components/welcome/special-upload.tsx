        ...
        >
          ...
          <motion.div variants={STAGGER_CHILD_VARIANTS}>
            ...
            {/* {currentLinkId && currentDocId && ( */}
              ...
              {currentLinkId && currentDocId ? (
              <main className="min-h-[300px] px-6 py-10">
  <div className="flex flex-col items-center justify-center space-y-8">
    {/* Document Link Section */}
    <div className="relative w-full max-w-3xl bg-white shadow-md rounded-lg p-6">
      <h2 className="text-lg font-semibold text-gray-800 mb-4">
        Your Pitch Link
      </h2>
      <div className="flex items-center space-x-4">
        <p
          className="block w-full overflow-y-auto rounded-md border border-gray-300 bg-gray-100 px-4 py-2 text-sm leading-6 text-gray-700 md:min-w-[500px]"
          title="Document Link"
        >
          {`${process.env.NEXT_PUBLIC_MARKETING_URL}/view/${currentLinkId}`}
        </p>

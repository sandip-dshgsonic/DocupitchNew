        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="font-seminbold mx-0 mb-8 mt-4 p-0 text-center text-xl">
              Thanks for upgrading to DocuPitch {planType}!
            </Text>
            <Text className="text-sm leading-6 text-black">
              Hey{name && ` ${name}`}!
            </Text>
            <Text className="text-sm">
              My name is Marc, and I&apos;m the creator of DocuPitch. I wanted
              to personally reach out to thank you for upgrading to DocuPitch{" "}
              {planType}!
            </Text>
            <Text className="text-sm leading-6 text-black">
              As you might already know, we are a bootstrapped and{" "}
              <Link
                href="https://github.com/mfts/docupitch"
                target="_blank"
              ...
              to build and improve DocuPitch.
            </Text>
            <Text className="text-sm leading-6 text-black">
            ...
            <Section>
              ...
              <Text className="text-sm text-gray-400">Marc from DocuPitch</Text>
            </Section>
            <Hr />

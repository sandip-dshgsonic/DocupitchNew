      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm">With DocuPitch Data Rooms you can:</Text>
            <Text className="text-sm">
              ...
              <Text className="text-sm">
                All about DocuPitch{" "}
                <a
                  href="https://docupitch.com/data-room"
            ...
            <Section className="mb-[32px] mt-[32px] text-center">
              <Button
                ...
                href={`https://docupitch.com/datarooms?utm_source=dataroom-info&utm_medium=email&utm_campaign=20240723&utm_content=upload_documents`}
            ...
            <Text className="text-sm">
              If you want to self-host DocuPitch, and build fully customizable
              experience{" "}
              <a

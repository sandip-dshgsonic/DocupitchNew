      ...
      <Tailwind>
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 w-[465px] p-5">
            ...
            <Text className="text-sm">With DocuPitch you can:</Text>
            <Text className="text-sm">
              <ul className="list-inside list-disc text-sm">
                ...
                <li>Remove &quot;powered by DocuPitch&quot;</li>
            ...
            <Section className="mb-[32px] mt-[32px] text-center">
              <Button
                ...
                href={`https://docupitch.com/documents?utm_source=onboarding&utm_medium=email&utm_campaign=20240723&utm_content=upload_documents`}

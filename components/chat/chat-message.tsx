...
const mapMessageRole = {
  ...
  assistant: { icon: <PapermarkSparkle />, name: "DocuPitch Assistant" },
  function: { icon: <PapermarkSparkle />, name: "DocuPitch Assistant" },
  data: { icon: <PapermarkSparkle />, name: "DocuPitch Assistant" },
  tool: { icon: <PapermarkSparkle />, name: "DocuPitch Assistant" },
};

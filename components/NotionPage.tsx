...
//     };
//   }, [maxScrollPercentage,handleScroll]);
// // }, [maxScrollPercentage]);
...
const NotionPage = ({
  ...
  // Use useCallback to memoize trackPageView function
  ...
  }, [isPreview, linkId, documentId, viewId, versionNumber]);

  // Use useCallback to memoize handleScroll function

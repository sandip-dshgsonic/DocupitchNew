...
console.log('loho  ',logo)

  return (
    <div >
      <aside
        className={cn(
          "h-[100dvh-64px] w-full flex-shrink-0 flex-col justify-between gap-y-6 bg-white black px-4 pt-4 dark:bg-black lg:w-72 lg:px-6 lg:pt-6",
          className,
        )}
        style={{marginTop:'64px' , borderRight:'1px solid #E5E7EB'}}
      >
  ...
  <Link href="/">
          ...
          <img src={logo.src} style={{ height: '50px', width: '50px' }} className="m-2" /></Link>{" "} DocuPitch{" "}
        ...
        {/* <Separator className="mb-0 bg-gray-200 dark:bg-gray-800" /> */}
              ...
              {navigation.map((item) => {
                  ...
                  return (
                    <div key={item.name}>
                      <button
                        ...
                        className={cn(
                          item.current
                            ? "bg-gray-200 font-semibold text-foreground dark:bg-gray-700"
                ...
                return (
                  <button
                    ...
                    className={cn(
                      item.current
                        ? "bg-[#F9FAFB] font-semibold text-[#F97316] dark:bg-secondary"
                        : "duration-200 hover:bg-gray-200 hover:dark:bg-muted",
                      "group flex w-full items-center gap-x-2 rounded-md px-3 py-2 text-sm leading-6 disabled:cursor-default disabled:text-muted-foreground disabled:hover:bg-transparent",
                    )}
                  >

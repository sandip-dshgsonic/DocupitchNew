...
export default function VisitorsTable({ numPages }: { numPages: number }) {
  ...
  console.log("views ======== visitor table",views)
    ...
    <div className="w-full">
                ...
                <Collapsible key={view.id} asChild>
                  <>
                        ...
                        <div className="flex items-center overflow-visible sm:space-x-3">
                          ...
                          <div className="min-w-0 flex-1">
                            <div className="focus:outline-none">
                              <p className="flex items-center gap-x-2 overflow-visible text-sm font-medium text-gray-800 dark:text-gray-500">
                                {view.viewerEmail ? (
                                  <>
                                    {view.viewerEmail}{" "}
                                    {view.verified && (
                              ...
                              <p className="text-xs text-muted-foreground/60 sm:text-sm">
                                ...
                                {/* *******{view.viewsWithDuration[0].link.name} */}
                    ...
                    <CollapsibleContent asChild>
                      <>
                        <TableRow className="hover:bg-transparent hover:text-gray-500">
                          <TableCell colSpan={5}>
                            {!isFreePlan ? (
                            ...
                            <div className="pb-0.5 pl-0.5 md:pb-1 md:pl-1">
                              <div className="flex items-center gap-x-1 px-1">
                                <FileDigitIcon className="size-4" /> Pitch
      ...
      <div className="rounded-md border">
        <Table>
          ...
          <TableBody>
            {views?.viewsWithDurationVideo.length === 0 &&
              views?.hiddenViewCount === 0 && (
                <TableRow>
                  <TableCell colSpan={5}>
                    <div className="flex h-40 w-full items-center justify-center">

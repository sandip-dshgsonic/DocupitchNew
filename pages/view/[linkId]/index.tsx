      ...
      return {
        props: {
          ...
          meta: {
            ...
            metaUrl: `https://docupitch.com/view/${linkId}`,
          },
      ...
      return (
        <>
          <CustomMetatag
            ...
            title={
              meta.metaTitle ??
              `${link?.document?.name} | Powered by DocuPitch` ??
              "Pitch powered by DocuPitch"
            }
      ...
      return (
        <>
          <CustomMetatag
            ...
            title={
              meta.metaTitle ??
              `${link?.dataroom?.name} | Powered by DocuPitch` ??
              "Dataroom powered by DocuPitch"
            }
            description={meta.metaDescription ?? null}
            imageUrl={meta.metaImage ?? null}
            url={meta.metaUrl ?? ""}

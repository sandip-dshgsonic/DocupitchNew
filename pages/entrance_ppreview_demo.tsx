    ...
    <>
      <div className="bg-gray-950" style={{ backgroundColor: accentColor }}>
        ...
        <div className="mx-auto px-2 sm:px-6 lg:px-8">
          ...
          <img src='/logo.png' style={{ height: '80px', width: '80px' }} alt='.' className="mx-auto" />
            <h1
              ...
              <div className="pb-5">
                <div className="relative space-y-2 rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    autoFocus
                    className="flex w-full px-2 rounded-md border-0 bg-black py-1.5 text-white shadow-sm ring-1 ring-inset ring-gray-600 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-300 sm:text-sm sm:leading-6"

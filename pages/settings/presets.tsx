                ...
                <div>
                  ...
                  <div className="relative mt-1 flex rounded-md shadow-sm">
                    ...
                    <Input
                      ...
                      placeholder={`DocuPitch - open-source document sharing infrastructure.`}
                ...
                <div>
                  ...
                  <div className="relative mt-1 flex rounded-md shadow-sm">
                    ...
                    <Textarea
                      ...
                      maxLength={240}
                      className="focus:ring-inset"
                      placeholder={`DocuPitch is an open-source document sharing infrastructure for modern teams.`}

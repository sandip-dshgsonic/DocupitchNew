...
export default async function handle(
  ...
  const pageViewObject = {
    ...
    // name: "Page View",  // Add a 'name' field with an appropriate value
  };
  ...
  if (!result.success) {
    ...
    // console.log('-----------123',result," -----------1123")
  }

  // console.log("record view data before publishing: ", JSON.stringify(result.data, null, 2));
